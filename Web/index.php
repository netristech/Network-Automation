...
?>
    <div id="login" class="container text-center">
        <form id="login-form" class="align-middle mx-auto" action="" method="post" enctype="multipart/formdata">
            ...
            <input id="password" class="col col-8" type="password" name="password" value="" /><br /><br />
            <input type="submit" name="submit" value="Sign in" class="btn btn-primary" style="width: 85%;" />
        </form>
    </div>
