...
?>
    ...
    <div id="sites" class="container">
        <div id ="nav" class="row pt-2 mb-2">
            <!--<button id="edit-btn" type="button" class="btn btn-primary mr-2 mb-2"><i class="far fa-edit"></i></button>-->
            <button id="import-btn" type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#import-modal">
            ...
            <button id="sign-out-btn" type="button" class="btn btn-secondary">
